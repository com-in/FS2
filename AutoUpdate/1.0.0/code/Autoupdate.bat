...
echo 正在删除旧版本
del filesafe2.exe
echo 正在下载新版本（如长时间卡住请使用加速器，也有可能是服务器崩了，具体可在https://stats.uptimerobot.com/KCWgj2f0Eo查看，因为检测服务器在国外，所以有时候会显示宕机但是并没有）
powershell -Command Invoke-WebRequest -Uri "http://opls.file-port.down.121686.xyz:33232/d/Github/FS2/filesafe2.exe?sign=mnS_DIdaH7qfdSJPXNK0wJ4g8slCWUjxoCvmAI_HLDQ=:0" -OutFile %cd%\filesafe2.exe
echo 更新完成
pause
